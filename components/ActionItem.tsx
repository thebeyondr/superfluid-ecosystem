...
const ActionItem = ({
    ...
    <Wrapper link={link} clickHandler={clickHandler}>
        <div className="flex items-center justify-start w-full px-3 py-3 md:py-5 space-x-4 rounded-xl bg-stone-950/60 transition ring-1 ring-stone-600 hover:ring-orange-300 hover:translate-x-1 active:ring-orange-300 focus:ring-orange-200">
